...
public class UnmannedTraffic {
    ...
    // Функция получает - L дороги, N - кол-во светофоров,
    // дорога int[][] track, {0,0} - расположение светофора, {0,1} - время показа красного света, {0,2} - время показа зелёного цвета.
